...
function TechnicalSection({
  ...
  children,
  ...props
}: Omit<React.HTMLProps<HTMLDivElement>, "title"> & { title: React.ReactElement }) {
  return (
...
function NestedList(props: React.HTMLProps<HTMLUListElement>) {
  return <ul className="border-l-2 border-gray-700 pl-4 pt-4 pb-4 mt-2 mb-2" {...props} />;
}

const TechnicalSkills = (props: Props) => {
  return (
    <div className="pt-16 p-4 bg-blue-100">
      <h4 className="uppercase tracking-widest mb-3 text-gray-400">Experience... I Have.</h4>
      <h1 className="text-3xl font-medium">Technical Skills</h1>
      <TechnicalSection title={<span className="bg-yellow-300 p-2">JavaScript</span>}>
        <ul>
          <li>Node.js</li>
          <li>React.js</li>
          <li>Next.js</li>
